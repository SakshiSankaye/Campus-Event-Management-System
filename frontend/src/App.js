...
import StudentBrowseEvent from "./pages/students/BrowseEvents";
import StudentMyEvents from "./pages/students/MyRegistrations";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          element={<StudentBrowseEvent />}
        />
        <Route
          path="/student-my-events"
          element={<StudentMyEvents />}
        />
        <Route
